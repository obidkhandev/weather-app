import 'package:weather_app/data/model/detal/daily_item/daily_feels_like.dart';
import 'package:weather_app/data/model/detal/daily_item/daily_temp.dart';
import 'package:weather_app/data/model/main/weather_model.dart';
...
class DailyItem {
  ...
  factory DailyItem.fromJson(Map<String, dynamic> json) => DailyItem(
        ...
        // dailyTemp: DailyItem.fromJson(json['temp'] as Map<String, dynamic>),
